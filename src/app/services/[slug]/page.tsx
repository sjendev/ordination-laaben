    ...
    return (
        <main className="pt-48 pb-32 px-8 bg-transparent">
            <div className="max-w-4xl mx-auto">
                ...
                <footer className="mt-32 text-center py-20 bg-slate-900 text-white rounded-sm relative overflow-hidden group">
                    <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
                    <p className="text-slate-400 font-light mb-10 text-lg relative z-10">{t.services.bookingText}</p>
                    <a
                        href={BOOKING_LINK}
                        target="_blank"
